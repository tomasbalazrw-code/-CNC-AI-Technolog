...
async function handler(req,res){
 ...
 try{
  ...
  if(!p.plan.cadGeometry||p.plan.cadGeometry.processed!==true||p.plan.cadGeometry.mode!=="turning-envelope")return fail(res,400,"3D model nebol geometricky spracovaný na sústružnícky profil.");
